...
public class KuduReader implements AutoCloseable {
    ...
    public KuduRowDataReaderIterator scannerRowData(byte[] token) throws IOException {
        return new KuduRowDataReaderIterator(KuduScanToken.deserializeIntoScanner(token, client));
    }
