...
import static com.psosuo.flink.kudu.table.KuduTableFactory.KUDU_HASH_COLS;
import static com.psosuo.flink.kudu.table.KuduTableFactory.KUDU_PRIMARY_KEY_COLS;
import static com.psosuo.flink.kudu.table.KuduTableFactory.KUDU_REPLICAS;
...
public class KuduCatalog extends AbstractReadOnlyCatalog {
    ...
    private static final Logger logger =LoggerFactory.getLogger(KuduCatalog.class);
    ...
    public void close() {
        try {
            ...
            logger.error("Error while closing kudu client", e);
        }
    }
