package com.psosuo.flink.kudu.batch;/*
...
import com.psosuo.flink.kudu.connector.reader.KuduInputSplit;
import com.psosuo.flink.kudu.connector.reader.KuduReader;
...
import com.psosuo.flink.kudu.table.KuduCatalog;
 ...
 */
@PublicEvolving
public class KuduRowDataInputFormat extends RichInputFormat<RowData, KuduInputSplit> {
    ...
    private transient KuduRowDataReaderIterator resultIterator;

    public KuduRowDataInputFormat(KuduReaderConfig readerConfig, KuduTableInfo tableInfo) {
        this(readerConfig, tableInfo, new ArrayList<>(), null);
    }

    public KuduRowDataInputFormat(KuduReaderConfig readerConfig, KuduTableInfo tableInfo, List<String> tableProjections) {
        this(readerConfig, tableInfo, new ArrayList<>(), tableProjections);
    }

    public KuduRowDataInputFormat(KuduReaderConfig readerConfig, KuduTableInfo tableInfo, List<KuduFilterInfo> tableFilters, List<String> tableProjections) {
    ...
    public void open(KuduInputSplit split) throws IOException {
        ...
        resultIterator = kuduReader.scannerRowData(split.getScanToken());
    }
