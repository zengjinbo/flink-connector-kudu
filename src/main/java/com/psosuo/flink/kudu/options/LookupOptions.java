...
public class LookupOptions implements Serializable {
	...
	public boolean equals(Object o) {
		if (o instanceof LookupOptions) {
			LookupOptions options = (LookupOptions) o;
	...
	/**
	 * Builder of {@link LookupOptions}.
	 */
	public static class Builder {
		private long cacheMaxSize = 100000L;
		private long cacheExpireMs = 10L;
		...
		public LookupOptions build() {
			return new LookupOptions(cacheMaxSize, cacheExpireMs, maxRetryTimes);
		}
	}
}
